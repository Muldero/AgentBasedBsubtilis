...
#install.packages(list_of_packages, dependencies = TRUE, lib = "Packages")




#new_packages <- list_of_packages[!(list_of_packages %in% installed.packages(lib.loc = "Packages")[,"Package"])]

#if (length(new_packages) > 0) {
#  install.packages(new_packages, lib = "Packages")
#}
